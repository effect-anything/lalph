...
export const commandProjectsEdit = Command.make("edit").pipe(
  Command.withDescription(
    "Edit a project's execution settings (concurrency, execution mode, target branch, git flow, research agent, review agent, review completion) and issue source settings.",
  ),
  Command.withHandler(
